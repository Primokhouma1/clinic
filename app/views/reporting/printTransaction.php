...
<page backtop="15mm" backbottom="20mm" backleft="10mm" backright="10mm">
    ...
    <table  width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr >
            <td style="text-align: left; padding: 40px 10px 25px 10px" ><strong><?php echo $this->lang['Transaction']; ?><?php echo date('Y-m-d'); ?></strong></td>
        </tr>
    </table>
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr style="background-color: #f0f0f0">
            ...
            <th style="text-align: left; padding: 5px 10px 5px 10px" class="tiret">
                <strong><?php echo $this->lang['labnumcaisse']; ?></strong></th>
