...
>>>>>>> Stashed changes
                    ...
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        <label for="profil" class="control-label"><?php echo $this->lang['profils']; ?></label>
                        <input type="text" id="profil" name="profil" class="form-control" placeholder="<?php echo $this->lang['profils']; ?>"
                               style="width: 100%" required>
                        <span class="help-block with-errors"> </span>
                        <?php //print $token;?>
                    </div>
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        <label for="module" class="control-label"><?php echo $this->lang['thTypep']; ?> </label>
                        <select id="type_profil" name="type_profil" class="form-control" style="width: 100%" required>
